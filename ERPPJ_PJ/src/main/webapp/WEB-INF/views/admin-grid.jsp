                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">See how aspects of the Bootstrap grid
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Grid Example</h4>
                                        <p class="sub-header mb-2">
                                            Don't want your columns to simply stack in smaller devices? Use the extra small and medium device grid classes by adding <code>.col-*</code> <code>.col-md-*</code>
