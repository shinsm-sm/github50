                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <a href="#" data-toggle="modal" data-target="#add-category" class="btn btn-lg btn-primary btn-block waves-effect m-t-10 waves-light">
                                                        ...
                                                        <div id="external-events">
                                                            ...
                                                            <div class="external-event bg-soft-success text-success" data-class="bg-success">
                                                                <i class="mdi mdi-checkbox-blank-circle mr-1"></i>New Theme Release
                                                            </div>
                                                            <div class="external-event bg-soft-info text-info" data-class="bg-info">
                                                                <i class="mdi mdi-checkbox-blank-circle mr-1"></i>My Event
                                                            </div>
                                                            <div class="external-event bg-soft-warning text-warning" data-class="bg-warning">
                                                                <i class="mdi mdi-checkbox-blank-circle mr-1"></i>Meet manager
                                                            </div>
                                                            <div class="external-event bg-soft-purple text-purple" data-class="bg-purple">
                                                                <i class="mdi mdi-checkbox-blank-circle mr-1"></i>Create New theme
                                                            </div>
                                                        </div>
