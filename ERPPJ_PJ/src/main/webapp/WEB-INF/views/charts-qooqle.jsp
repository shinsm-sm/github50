                                        ...
                                        <div dir="ltr">
                                            ...
                                            <div class="text-center">
                                                <p class="text-uppercase mb-0">
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-primary"></i> Series A</span>
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-purple"></i> Series B</span>
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-muted"></i> Series C</span>
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="morris-area-example" class="morris-chart" style="height: 320px;"></div>
        
                                            <div class="text-center">
                                                <p class="text-uppercase mb-0">
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-muted"></i> Series A</span>
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-muted"></i> Series B</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            ...
                                            <div class="text-center">
                                                <p class="text-uppercase mb-0">
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-info"></i> Series A</span>
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-pink"></i> Series B</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div dir="ltr">
                                            ...
                                            <div class="text-center">
                                                <p class="text-uppercase mb-0">
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-primary"></i> Series A</span>
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-purple"></i> Series B</span>
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-info"></i> Series C</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="morris-area-with-dotted" class="morris-chart" style="height: 320px;"></div>
    
                                        <div dir="ltr">
                                            <div class="text-center">
                                                <p class="text-uppercase mb-0">
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-dark"></i> Series A</span>
                                                    <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-muted"></i> Series B</span>
                                                </p>
                                            </div>
                                        </div>
