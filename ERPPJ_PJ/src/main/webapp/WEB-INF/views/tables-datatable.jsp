                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        ...
                                        <h4 class="header-title">Fixed Header example</h4>
                                        <p class="sub-header">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        ...
                                        <h4 class="header-title">KeyTable example</h4>
                                        <p class="sub-header">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        ...
                                        <h4 class="header-title">Responsive example</h4>
                                        <p class="sub-header">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        ...
                                        <h4 class="header-title">Scroller Datatable example</h4>
                                        <p class="sub-header">
                                            Your awesome text goes here.
                                        </p>
    
                                        <table id="datatable-scroller" class="table table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>First name</th>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="header-title">ColVis Example</h4>
                                        <p class="sub-header">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="header-title">Fixed Column Example</h4>
                                        <p class="sub-header">
                                            In this example the column index is prefixed to the column title.
                                        </p>
