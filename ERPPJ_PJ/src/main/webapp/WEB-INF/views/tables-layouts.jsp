                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">
                                            <code>.bg-primary .text-white</code> Class  Use <code>&lt;thead&gt;</code>
                                        </p>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">
                                            <code>.bg-success .text-white</code> Class  Use <code>&lt;thead&gt;</code>
                                        </p>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">
                                            <code>.bg-info .text-white</code> Class  Use <code>&lt;thead&gt;</code>
                                        </p>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">
                                            <code>.bg-warning .text-white</code> Class  Use <code>&lt;thead&gt;</code>
                                        </p>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">
                                            <code>.bg-danger .text-white</code> Class  Use <code>&lt;thead&gt;</code>
                                        </p>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">
                                            <code>.bg-purple .text-white</code> Class  Use <code>&lt;thead&gt;</code>
                                        </p>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">
                                            <code>.bg-pink .text-white</code> Class  Use <code>&lt;thead&gt;</code>
                                        </p>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">
                                            <code>.bg-dark .text-white</code> Class  Use <code>&lt;thead&gt;</code>
                                        </p>
